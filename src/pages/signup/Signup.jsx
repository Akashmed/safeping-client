      ...
      <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form onSubmit={handleSignUp} className="w-full max-w-md">
          ...
          <div className="relative flex items-center mt-8">
            ...
            <input name='name' type="text" className="block w-full py-3 pl-11 pr-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="User Name" required />
          </div>
          <label
            ...
            <input onChange={(e) => setImage(e.target.files[0].name)}
              name='image' id="dropzone-file" type="file" accept='image/*' className="hidden" required />
          </label>
